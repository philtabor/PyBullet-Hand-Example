...
wrist_pro_cid = p.createConstraint(hand, 0, hand, 1, p.JOINT_FIXED, [0,0,0], [0,0,0], [0,0,0])
wrist_pro2_cid = p.createConstraint(hand, 2, hand, 3, p.JOINT_FIXED, [0,0,0], [0,0,0], [0,0,0])
